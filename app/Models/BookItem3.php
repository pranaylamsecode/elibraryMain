...
class BookItem3 extends Model
{
    ...
    {
        return $this->belongsTo(Book3::class, 'book_id');
    }
    ...
    {
        return $this->hasMany(IssuedBook3::class, 'book_item_id');
    }
    ...
    {
        return $this->hasOne(IssuedBook3::class, 'book_item_id')
            ->lastIssuedBook();
    }
    ...
    {
        return $this->belongsTo(Publisher3::class, 'publisher_id');
    }
    ...
    {
        return $this->belongsTo(BookLanguage3::class, 'language_id');
    }
    ...
    public function getBookItemStatusAttribute()
    {
        ...
        return IssuedBook3::STATUS_AVAILABLE;
    }
    ...
    public function getEBookUrlAttribute()
    {
        if ($this->format == self::FORMAT_E_BOOK) {
            return (Auth::user() instanceof User3) ? url('b1/book-items/' . $this->id . '/download') :
    ...
    public function apiM1Obj()
    {
        ...
        $bookItem = [
            ...
            'is_reserved'             => ($this->lastIssuedBook) ? $this->lastIssuedBook->status == IssuedBook3::STATUS_RESERVED ? true : false : false,
