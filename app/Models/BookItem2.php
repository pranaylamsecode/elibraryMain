...
class BookItem2 extends Model
{
    ...
    {
        return $this->belongsTo(Book2::class, 'book_id');
    }
    ...
    {
        return $this->hasMany(IssuedBook2::class, 'book_item_id');
    }
    ...
    {
        return $this->hasOne(IssuedBook2::class, 'book_item_id')
            ->lastIssuedBook();
    }
    ...
    {
        return $this->belongsTo(Publisher2::class, 'publisher_id');
    }
    ...
    {
        return $this->belongsTo(BookLanguage2::class, 'language_id');
    }
    ...
    public function getBookItemStatusAttribute()
    {
        ...
        return IssuedBook2::STATUS_AVAILABLE;
    }
    ...
    public function getEBookUrlAttribute()
    {
        if ($this->format == self::FORMAT_E_BOOK) {
            return (Auth::user() instanceof User2) ? url('b1/book-items/' . $this->id . '/download') :
    ...
    public function apiM1Obj()
    {
        ...
        $bookItem = [
            ...
            'is_reserved'             => ($this->lastIssuedBook) ? $this->lastIssuedBook->status == IssuedBook2::STATUS_RESERVED ? true : false : false,
            'library_id'              => $this->book ? $this->book->library_id : null
        ];
